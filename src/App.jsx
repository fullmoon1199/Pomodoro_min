...
function App() {
  ...
  const [workDuration, setWorkDuration] = useState(0.1 * 60); // 일하는 시간 x초*60
  const [restDuration, setRestDuration] = useState(0.1 * 60); // 쉬는 시간 y초*60
  ...
  return (
    <div className={"AppDiv"}>
      ...
      <button className={"settingBtn"} title="Setting" onClick={<Setting />}>
        setting
      </button>
